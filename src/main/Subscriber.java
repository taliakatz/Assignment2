...
public abstract class Subscriber extends RunnableSubPub {
    ...
    public Subscriber(String name) {
        super(name);
        this.mb = MessageBrokerImpl.getInstance();
        this.callbackHashMap=new HashMap<>();
        counter = AtomicCounter.getInstance();
    }
    ...
    /**
     * The entry point of the Subscriber. TODO: you must complete this code  //we have completed
    ...
    public final void run() {
        ...
        while (!terminated && !Thread.currentThread().isInterrupted() ) {
            try {
                ...
                if(msg!=null&& !callbackHashMap.isEmpty() && callbackHashMap.get(msg.getClass())!=null ) {
